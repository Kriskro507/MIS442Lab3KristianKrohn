    ...
    public class ProductDB : DBBase, IReadDB, IWriteDB
    {
        ...
        public IBaseProps Create(IBaseProps p)
        {
            ...
            try
            {
                ...
                if (rowsAffected == 1)
                {
                    props.ConcurrencyID = 1; // Assuming concurrency starts at 1
                    return props;
                }
                else
        ...
        public IBaseProps Retrieve(object key)
        {
            ...
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.Add("conCurrId", DBDbType.VarChar);
            command.Parameters["conCurrId"].Value = key.ToString();
